...
// xetla.hpp includes experimental/experimental.hpp before the core common/group/
// kernel/subgroup headers, but the experimental impls explicitly specialize core
// primary templates (group_reduce_t, gemm_t, gemm_universal_t, ...) without seeing
// them declared first; pre-include the core umbrella so those declarations exist.
