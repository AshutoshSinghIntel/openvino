...
void TransformationsPipeline::apply(std::shared_ptr<ov::Model> func) {
    ...
    const ov::element::TypeVector supported_woq_types = {ov::element::u8, ov::element::i8, ov::element::u4, ov::element::i4, ov::element::ut2, ov::element::ut1_5};
    bool enableInt8;
...

    {
        ...
        manager.register_pass<ov::pass::MarkDequantization>(
            std::vector<ov::element::Type>{ ov::element::i8, ov::element::u8, ov::element::i4, ov::element::u4, ov::element::ut2, ov::element::ut1_5},
